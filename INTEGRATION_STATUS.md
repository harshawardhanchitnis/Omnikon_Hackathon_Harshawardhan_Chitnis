...
| Teach/Present Mode                 | Implemented/tested at unit level | Typed blocks; explicit learner DTO excludes private teaching fields   |
...
| Browser E2E/axe                 | v3 suite implemented              | **Current v3 suite awaiting GitHub Actions; local Chromium unavailable** | Re-run automatically after branch publication                |
